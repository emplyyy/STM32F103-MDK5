...
#define Multi_Button_Callback  0x04//2位:回调函数方式2  1位:回调函数方式1  0位:查询方案  
#if (Multi_Button_Callback&0x06)==0x06
#if  (Multi_Button_Callback&0x01)==0
#define Multi_Button_Callback  0x04//两种回调函数，优先用方式2
#endif
#if  (Multi_Button_Callback&0x01)==1
#define Multi_Button_Callback  0x05//两种回调函数，优先用方式2
#endif
#endif
