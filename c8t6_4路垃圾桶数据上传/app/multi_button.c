...
void Multi_Button_Test(void)
{
	...
	while(1) 
	{
#if (Multi_Button_Callback&0x01) >0
...
#define Button1_Enable 0             //按下是低电平
struct  Button         Button1;
 
 
#if (Multi_Button_Callback&0x02) >0
...
#endif
#if (Multi_Button_Callback&0x04) >0
void BTN1_Handler(void* btn)
{
	u8  Button1_Event;
    Button1_Event = Get_Button_Event(&Button1);
    switch(Button1_Event)
    {
	    case PRESS_DOWN:
	        printf("PRESS_DOWN_Callback\r\n"); 
	    	break; 
...
void Multi_Button_Init(void)
{
	...
	//定义按键按下电平
	Button_Init  (&Button1, Read_Button1_GPIO, Button1_Enable);//按下时低电平
...
#endif
#if (Multi_Button_Callback&0x04) >0
	Button_Attach(&Button1, PRESS_DOWN,        BTN1_Handler);
	Button_Attach(&Button1, PRESS_UP,          BTN1_Handler);
	Button_Attach(&Button1, PRESS_REPEAT,      BTN1_Handler);
	Button_Attach(&Button1, SINGLE_CLICK,      BTN1_Handler);
	Button_Attach(&Button1, DOUBLE_CLICK,      BTN1_Handler);
	Button_Attach(&Button1, LONG_RRESS_START,  BTN1_Handler);
	Button_Attach(&Button1, LONG_PRESS_HOLD,   BTN1_Handler);
#endif
}
////////////////////////////////////////移植修改区域///////////////////////////////////////////////////////////
